...
function trackFrameDataReducer(state, action) {
  switch (action.type) {
    case DATA: {
 ...
 * @returns Object
 */
function useTrackFrameData({ reducer = trackFrameDataReducer } = {}) {
...
export { useTrackFrameData, initialState, trackFrameDataReducer };
